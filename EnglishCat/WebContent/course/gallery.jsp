      ...
      <div id="roof" class="hidden-xs">
          <div class="container">
              ...
              <div class="quick-contacts pull-right">
                  ...
                  <span><a href="<%=request.getContextPath()%>/account/login.jsp"><i class="fa fa-user"></i> Login</a> / <a href="<%=request.getContextPath()%>/account/registration.html">Register</a></span>
              </div>
              <!-- Quick Contacts End -->
          </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="controls text-center">
            ...
            <a class="filter btn btn-common" data-filter=".business">
              Business 
            </a>
            ...
            <a class="filter btn btn-common" data-filter=".blog">
              Blog 
            </a>
          </div>
          ...
          <div id="portfolio-list">
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix design branding">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img1.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img1.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
            ...
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix business branding">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img2.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img2.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
            ...
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix branding blog">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img3.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img3.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
            ...
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix design blog">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img4.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img4.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
            ...
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix design business">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img5.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img5.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
            ...
            <div class="col-md-3 col-lg-4 col-sm-6 col-xs-12 mix branding blog">
              <div class="portfolio-item">
                <div class="portfolio-img">
                  <img src="<%=request.getContextPath()%>/assets/img/portfolio/img6.jpg" alt="" />                  
                </div> 
                <div class="portfoli-content">
                  <div class="sup-desc-wrap">
                    <div class="sup-desc-inner">
                      <div class="sup-link">
                        <a class="left-link lightbox" href="<%=request.getContextPath()%>/assets/img/portfolio/img6.jpg"><i class="fa fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>               
